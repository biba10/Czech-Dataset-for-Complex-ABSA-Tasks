...
from src.utils.config import SENTIMENT2LABEL


class ABSAModelClassification(pl.LightningModule):
    ...
    def __init__(
        ...
        self._model = model
        self._pd_f1_score = MulticlassF1Score(num_classes=len(SENTIMENT2LABEL), average="micro")
    ...
    def validation_step(self, batch: dict, batch_idx: int) -> dict:
        ...
        self.log("pd_f1", self._pd_f1_score, prog_bar=True, sync_dist=True)
    ...
    def test_step(self, batch: dict, batch_idx: int) -> dict:
        ...
        self.log("test_pd_f1", self._pd_f1_score, prog_bar=True, sync_dist=True)
    ...
    def _compute_loss_and_update_metric(self, batch):
        ...
        loss = output.loss
        self._pd_f1_score.update(output.logits, batch["labels"])
        return loss
