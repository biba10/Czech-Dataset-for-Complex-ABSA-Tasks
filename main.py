...
def main():
    ...
    trainer_logger = CSVLogger(save_dir=os.getcwd(), name="logs")
    ...
    absa_model, tokenizer = load_model_and_tokenizer(
        ...
        max_seq_length_label=args.max_seq_length_label,
